...
namespace NCPSKYGameToolset
{
    /// <summary>
    /// 加密解密工具集
    /// </summary>
    public static class StringSecurityTools
    {
        #region SHA1 加密
        /// <summary>
        /// 使用SHA1加密字符串。
        ...
        #region DES 加密/解密
        private static byte[] key = Encoding.ASCII.GetBytes("88888888");
        private static byte[] iv = Encoding.ASCII.GetBytes("11111111");
